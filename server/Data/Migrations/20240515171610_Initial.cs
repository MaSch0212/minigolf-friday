...
namespace MinigolfFriday.Data.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    registration_deadline = table.Column<DateTimeOffset>(
                        type: "TEXT",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table
                        .Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    login_token = table.Column<string>(
                        type: "TEXT",
                        maxLength: 32,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_users_to_avoided_users",
                        x => new { x.avoided_user_id, x.user_id }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_users_to_preferred_users",
                        x => new { x.preferred_user_id, x.user_id }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    event_instance_preconfiguration_id = table.Column<long>(
                        type: "INTEGER",
                        nullable: false
                    ),
                    user_id = table.Column<long>(type: "INTEGER", nullable: false)
                ...
                {
                    table.PrimaryKey(
                        "PK_users_to_event_instance_preconfigurations",
                        x => new { x.event_instance_preconfiguration_id, x.user_id }
                    );
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "PK_event_instances_to_users",
                        x => new { x.event_instance_id, x.user_id }
                    );
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "event_instances_to_users");

            migrationBuilder.DropTable(name: "event_timeslot_registration");

            migrationBuilder.DropTable(name: "users_to_avoided_users");

            migrationBuilder.DropTable(name: "users_to_event_instance_preconfigurations");

            migrationBuilder.DropTable(name: "users_to_preferred_users");

            migrationBuilder.DropTable(name: "users_to_roles");

            migrationBuilder.DropTable(name: "event_instances");

            migrationBuilder.DropTable(name: "event_instance_preconfigurations");

            migrationBuilder.DropTable(name: "roles");

            migrationBuilder.DropTable(name: "users");

            migrationBuilder.DropTable(name: "event_timeslots");
